  ...
  return (
    <footer className={styles.footer}>
      <div className={styles.grid}>
        <a href="/" className={styles.button}><img src={button}/></a>
        ...
        <div className={styles.info}>
          ...
          <a className={styles.email} href="">award@digital-lawyers.ru</a>
        </div>
      ...
      <div className={styles.note}>
        <p className={styles.noteText}>© ООО «Диджитал Скиллс» 2019-2022 года. Все права защищены. Любое использование либо копирование материалов или подборки материалов сайта, элементов дизайна и оформления может осуществляться лишь с письменного согласия ООО «Диджитал Скиллс» и только при наличии ссылки на настоящий сайт.</p>
        <div className={styles.privacyPolicy}>
          <p className={styles.privacyPolicyText}>Политика конфиденциальности</p>
          <p className={styles.privacyPolicyText}>Разработка сайта - Синектика</p>
        </div>
      </div>
    </footer>
  );
